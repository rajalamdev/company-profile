    ...
    <div className="bg-gray-100 h-screen">
      ...
      <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
        ...
        <div className="buttons flex">
          ...
          <button disabled={loading} onClick={addTestimonial} className={`btn border  p-1 px-4 font-semibold ${loading ? 'cursor-not-allowed opacity-70' : "cursor-pointer"} text-gray-200 ml-2 bg-slate-900`}>
